...
TargetGroupBox:AddSlider("MaxDistanceSlider", { Text = "Max Lock Distance (Studs)", Default = 10000, Min = 1, Max = 9999999999999999999999999999999999999999999999999999, Rounding = 0 })
...
ThemeManager:SetFolder("hooksensev2")
SaveManager:SetFolder("hooksensev2/configs")
