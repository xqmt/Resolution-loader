...
-- // Functions
	...
	do
		...
		function Library:Window(Options)
			...
			-- Make drag area larger for touch devices
			...
			-- // Dragging (Updated for mobile support)
        ...
        function Pages:Weapon(Properties)
			...
			--
			Library:Connection(New.InputBegan, function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		function Sections:Toggle(Properties)
			...
			--
			Library:Connection(NewToggle.InputBegan, function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					SetState()
				end
			end)
			...
			function Toggle:Keybind(Properties)
				...
				--
				Library:Connection(Hold.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
						set("Hold")
				...
				--
				Library:Connection(Toggle.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
						set("Toggle")
						Hold.TextColor3 = Color3.fromRGB(145,145,145)
				...
				--
				Library:Connection(Always.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
						set("Always")
						Hold.TextColor3 = Color3.fromRGB(145,145,145)
						Toggle.TextColor3 = Color3.fromRGB(145,145,145)
				...
				--
				Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
					if ModeOutline.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) then
		...
		function Sections:Slider(Properties)
			...
			--
			Library:Connection(Add.InputBegan, function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					Set(Val + 1)
				end
			end)
			--
			Library:Connection(Subtract.InputBegan, function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					Set(Val - 1)
				end
			end)
		...
		function Sections:Dropdown(Properties)
			...
			Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
				if ContainerOutline.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) then
		...
		function Sections:Button(Properties)
			...
			--
			Library:Connection(NewButton.InputBegan, function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					Button.Callback()
			...
			--
			Library:Connection(NewButton.InputEnded, function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					Value.TextColor3 = Color3.new(0.5686,0.5686,0.5686)
				end
			end)
